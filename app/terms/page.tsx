        ...
        <>
            ...
            <main className='relative max-w-4xl mx-auto px-10 mb-20 w-full font-sf'>
                <article className='mx-10 privacy'>
                    <h1 className='mt-16 text-4xl text-center gradient-cool'>Terms and Conditions</h1>
                    ...
                    <p>
                        Welcome to our website. If you continue to browse and use this website you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern DEEPAK SINGH NEGI&apos;s relationship with you in relation to this website.
                    </p>
                    <p>
                        The term &apos;DEEPAK SINGH NEGI&apos; or &apos;us&apos; or &apos;we&apos; refers to the owner of the website whose registered/operational office is Thano Road, Tarly jolly, Bhaniyawala Dehradun UTTARAKHAND 248140. The term &apos;you&apos; refers to the user or viewer of our website.
                    </p>
                    ...
                    <ul className='list-disc ml-10'>
                        ...
                        <li>
                            You may not create a link to this website from another website or document without DEEPAK SINGH NEGI’s prior written consent.
                        </li>
                        <li>
