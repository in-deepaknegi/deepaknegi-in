...
const Stack = () => {
    return (
        <section className='relative max-w-7xl mx-auto px-3 md:px-6 lg:px-10 mt-20 mb-10 font-sf'>
                ...
                <div className='max-w-4xl mx-auto grid grid-cols-3 gap-8 mt-20'>
                    <div className='flex gap-4 bg-gray-50 border p-3 rounded-xl'>
                        ...
                        <div className='overflow-hidden'>
                            ...
                            <div className='text-gray-500'>4 + year of experience</div>
                        </div>
                    </div>
                    <div className='flex gap-4 bg-gray-50 border p-3 rounded-xl'>
                        <div className='my-auto'>
                    ...
                    <div className='flex gap-4 bg-gray-50 border p-3 rounded-xl'>
                        ...
                        <div className='overflow-hidden'>
                            ...
                            <div className='text-gray-500'>3 + year of experience</div>
                        </div>
                    </div>
                    <div className='flex gap-4 bg-gray-50 border p-3 rounded-xl'>
                        <div className='my-auto'>
                    ...
                    <div className='flex gap-4 bg-gray-50 border p-3 rounded-xl'>
                        ...
                        <div className='overflow-hidden'>
                            <div className='text-xl font-medium'>Next</div>
                            <div className='text-gray-500'>2 + year of experience</div>
                        </div>
                    </div>
                    <div className='flex gap-4 bg-gray-50 border p-3 rounded-xl'>
                        <div className='my-auto'>
