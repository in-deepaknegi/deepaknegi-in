        ...
        <main className="relative flex flex-1 flex-col overflow-hidden px-4 py-1 sm:px-6 lg:px-8">
            ...
            <div className="relative flex flex-1 flex-col items-center justify-center pt-12">
                <a href='/' className='flex mx-auto mb-10 w-auto'>
                    <div className='my-auto ml-3 text-2xl'>Deepak Negi</div>
                </a>

                <div className='max-w-sm w-full'>
                    <button className='inline-flex justify-center rounded-lg text-base py-2.5 px-4 w-full border'>
                        <Image
                            src={GoogleLogo}
                            alt='google-logo'
                            width={20}
            ...
            <footer className="relative shrink-0">
                <div className="space-y-4 text-sm text-gray-900 sm:flex sm:items-center sm:justify-center sm:space-x-4 sm:space-y-0">
                    ...
                    <a className="inline-flex justify-center rounded-lg text-sm py-2.5 px-4 text-slate-900 ring-1 ring-slate-900/10 hover:ring-slate-900/20" href="/register">
