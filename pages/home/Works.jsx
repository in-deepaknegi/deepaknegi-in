    ...
    return (
        <section className='relative isolate'>
            ...
            <div className='relative mx-auto max-w-7xl  px-4 pt-16 sm:px-6 lg:px-8 lg:pt-10'>
                ...
                <div className='mx-auto grid max-w-4xl grid-cols-1 gap-x-8 gap-y-16 bg-gray-100 rounded-xl xl:max-w-none lg:grid-cols-3'>
                    <div className="flex flex-col lg:pb-6 px-4 mt-4">
                        ...
                        <div className="order-first flex items-center gap-2">
                            <p className="text-base font-semibold leading-7 text-slate-500">Ecommerce Website</p>
                        </div>
                        <p className="mt-6 text-base leading-7 text-slate-700">
                            I developed Mridakriti&apos;s website, contributing to the creation of a modern and user-friendly online presence. Leveraging my expertise, I collaborated closely with Mridakriti to design a responsive website and ensuring an engaging and seamless user experien
                        </p>
                    ...
                    <div className='block px-4 w-full mb-4 lg:absolute lg:w-[65%] lg:px-0 lg:right-[-1rem] lg:col-span-2'>
                        <Image
                            src={Mrida}
                            alt='mridakriti'
                            className='relative mt-4 z-20 rounded-xl bg-slate-200 shadow-xl shadow-black/20 ring-1 ring-slate-900/5 lg:mt-12'
                        />
                    </div>
                </div>
            </div>
